...
declare var $: any;
@Component({
  selector: 'app-confirmation-otp',
  templateUrl: './confirmation-otp.component.html',
  styleUrls: ['./confirmation-otp.component.css']
})
export class ConfirmationOtpComponent implements OnInit {
  ...
  constructor(
    ...
    if (isPlatformBrowser(this.platformId)) {
      ...
      this.hideNumber = localStorage.getItem("hideNumber");
    }
  }
